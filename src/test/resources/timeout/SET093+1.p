%--------------------------------------------------------------------------
% File     : SET093+1 : TPTP v7.2.0. Bugfixed v5.4.0.
% Domain   : Set Theory
...
% Status   : Theorem
% Rating   : 0.07 v7.1.0, 0.09 v7.0.0, 0.13 v6.4.0, 0.15 v6.3.0, 0.12 v6.2.0, 0.16 v6.1.0, 0.23 v6.0.0, 0.17 v5.5.0, 0.15 v5.4.0
